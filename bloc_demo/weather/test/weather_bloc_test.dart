...
import 'package:weather/blocs/weather_bloc.dart';
...
main() {
  group('WeatherBloc', () {
    ...
    test('has a corrent initialState', () {
      expect(weatherBloc.initialState, WeatherEmpty());
    });

    group('FetchWeather', () {
      test('emits [WeatherEmpty, WeatherLoading, WeatherLoaded] when weather repository returns weather',
        () {
